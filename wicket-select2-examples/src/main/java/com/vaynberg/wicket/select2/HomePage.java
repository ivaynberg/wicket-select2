...
public class HomePage extends WebPage {
	...
	public HomePage() {
		...
		Select2Choice<Country> country = new Select2Choice<Country>("country", new PropertyModel<Country>(this, "country"), new CountriesProvider());
	...
	/**
	 * Queries {@code pageSize} worth of countries from the {@link Country} enum, starting with {@code page * pageSize} offset. Countries are matched
	...
	/**
	 * {@link Country} based choice provider for Select2 components. Demonstrates integration between Select2 components and a domain object (in this
	 * case an enum).
	 * 
	 * @author igor
	 * 
